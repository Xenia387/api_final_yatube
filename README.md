...
# Возможности проекта
Аторизация с помощью модуля DRF – Authtoken, публикация и редактирование постов, добавление их в группы, публикация комментариев к постам, подписка на автора и отписка от него
